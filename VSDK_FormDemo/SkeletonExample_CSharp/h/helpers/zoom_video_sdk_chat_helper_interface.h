...
public:
     ...
     * @return If the function succeeds, it will return ZoomVideoSDKErrors_Success, otherwise failed. Otherwise failed. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 */
