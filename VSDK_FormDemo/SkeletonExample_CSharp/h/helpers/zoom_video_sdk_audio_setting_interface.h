...
public:
	 ...
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise failed. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 * \note The function is disabled if no event handler is set.
	 */
	 ...
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise failed. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 * \note This interface will stop the mic or speaker test (if there is on ongoing). As a best practice, call it before the audio test.
	 */
