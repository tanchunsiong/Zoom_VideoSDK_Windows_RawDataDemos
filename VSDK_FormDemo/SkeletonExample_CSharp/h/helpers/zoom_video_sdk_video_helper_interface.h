...
public:
	 ...
	 * @return If the function succeeds, the return value is IZoomVideoSDKUser object vector. Otherwise failed. the return value is nullptr.
	 */
	 ...
	 * @return The video device ID if successful. Otherwise returns nullptr.
	 */
	 ...
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise it fails. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 */
	 ...
	 * @param [out] preference_setting Specifies the video quality preference. When setting custom modes, the maximum and minimum frame rates are provided by the developer.
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise failed. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 */
	 ...
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors_Success. Otherwise, this function returns an error. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.	
	 */
	 ...
	 * @note This function need to call first before create virtual background object to get background item last time.
	 * @return If the function succeeds, the return value is IVirtualBackgroundItem object vector. Otherwise failed. the return value is nullptr.
	 */
	 ...
	 * @return If the function succeeds, the return value is IVirtualBackgroundItem object. Otherwise failed. the return value is nullptr.
	 */
	 ...
	 * @return If the function succeeds, the return value is SDKErr_Success. Otherwise failed. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 */
     ...
     * @return True indicates that current device supports it. Otherwise, it indicates that the device performance is weak and does not support it.
	 */
