...
public:
	 ...
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors. Otherwise, this function returns an error. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 */
...
public:
	 ...
	 * @return If the function succeeds, the return value is the remote camera control helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKRemoteCameraControlHelper \endlink.
	 */
