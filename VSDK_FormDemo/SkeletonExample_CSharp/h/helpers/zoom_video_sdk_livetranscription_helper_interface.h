...
public:
	 ...
	 * @return If the function succeeds, the return value is the message ID of the current message. Otherwise it fails, and the return value is the string of length zero(0)
	 */
...
public:
	 ...
	 * @note If the session allows multi-language transcription,all users can start live transcription.
	 ...
	 * @note If the session allows multi-language transcription,all users can stop live transcription.
	 * @return If the function succeeds, the return value is SDKErr_Success. Otherwise failed. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 */
	 ...
	 * @return If the function succeeds, the return value is the list of the available spoken languages in a session. Otherwise failed, the return value is nullptr.	
	 */
	 ...
	 * @return If the function succeeds, the return value is the list of all available translation languages in a session. Otherwise failed, the return value is nullptr.
	 */
	 ...
	 * @return If the function succeeds, the return value is ZoomVideoSDKErrors. Otherwise it fails. To get extended error information, see \link ZoomVideoSDKErrors \endlink enum.
	 */
	 ...
	 * @return If the function succeeds, the return value is a list of all history translation messages in a session. Otherwise it fails, and the return value is nullptr.
	 */
