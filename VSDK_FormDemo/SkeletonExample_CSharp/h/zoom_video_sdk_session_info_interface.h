...
public:
	 ...
	 * @return If the function succeeds, the return value is session name. Otherwise returns nullptr.
	 */
	virtual const zchar_t* getSessionName() = 0;
	
	/**
	 * @brief Get the session's password.
	 * @return If the function succeeds, the return value is session password. Otherwise returns nullptr.
	 */
	virtual const zchar_t* getSessionPassword() = 0;
	
	/**
	 * @brief Get the session phone passcode.
	 * @return If the function succeeds, the return value is session phone passcode. Otherwise returns nullptr.
	 */
	virtual const zchar_t* getSessionPhonePasscode() = 0;
	
	/**
	 * @brief Get the session ID.
	 * @return If the function succeeds, the return value is session ID. Otherwise returns nullptr.
	 ...
	 * @return If the function succeeds, the return value is session host name. Otherwise returns nullptr.
	 */
	virtual const zchar_t* getSessionHostName() = 0;
	
	/**
	 * @brief Get the session's host user object.
	 * @return If the function succeeds, the return value is session host user object. Otherwise returns nullptr.
	 */
	virtual IZoomVideoSDKUser* getSessionHost() = 0;
	
	/**
	 * @brief Get a list of the session's remote users.
	 * @return If the function succeeds, the return value is remote users list. Otherwise returns nullptr.
	 */
	virtual IVideoSDKVector<IZoomVideoSDKUser*>* getRemoteUsers() = 0;
	
	/**
	 * @brief Get the session's user object for myself.
	 * @return If the function succeeds, the return value is myself object. Otherwise returns nullptr.
	 */
