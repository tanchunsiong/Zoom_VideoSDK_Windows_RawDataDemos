...
public:
     ...
     * @return If the function succeeds, the return value is send user object, Otherwise nullptr.
	 */
    virtual IZoomVideoSDKUser* getSendUser() = 0;
	
	/**
	 * @brief Get the receive user object of the message.
	 * @return If the function succeeds, the return value is receive user object, Otherwise nullptr.
	 */
