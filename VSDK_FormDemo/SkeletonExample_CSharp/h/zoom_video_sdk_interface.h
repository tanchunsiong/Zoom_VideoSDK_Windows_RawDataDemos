...
public:
	 ...
	 * @return If the function succeeds, the return value is the pointer to IZoomVideoSDKSession object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKSession \endlink enum.
	 */
	 ...
	 * @return If the function succeeds, the return value is the audio helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKAudioHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the video helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKVideoHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the recording helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKVideoHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the user helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKUserHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the share helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKShareHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the live stream helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKLiveStreamHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the phone helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKPhoneHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the chat helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKChatHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the command channel object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKCmdChannel \endlink.
	 */
	virtual IZoomVideoSDKCmdChannel* getCmdChannel() = 0;

    /**
	 * @brief Get audio setting helper object.
	 * @return If the function succeeds, the return value is the audio setting helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKSettingHelper \endlink.
	 */
	virtual IZoomVideoSDKAudioSettingHelper* getAudioSettingHelper() = 0;

    /**
	 * @brief Get audio setting helper object.
	 * @return If the function succeeds, the return value is the audio device test helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKTestAudioDeviceHelper \endlink.
	 */
	virtual IZoomVideoSDKTestAudioDeviceHelper* GetAudioDeviceTestHelper() = 0;

    /**
	 * @brief Get network connection helper object.
	 * @return If the function succeeds, the return value is the network connection helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKNetworkConnectionHelper \endlink.
	 */
	virtual IZoomVideoSDKNetworkConnectionHelper* getNetworkConnectionHelper() = 0;

    /**
	 * @brief Get CRC helper object.
	 * @return If the function succeeds, the return value is the CRC helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKCRCHelper \endlink.
	 */
	virtual IZoomVideoSDKCRCHelper* getCRCHelper() = 0;

    /**
	 * @brief Get video setting helper object.
	 * @return If the function succeeds, the return value is the video setting helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKVideoSettingHelper \endlink.
	 */
	virtual IZoomVideoSDKVideoSettingHelper* getVideoSettingHelper() = 0;

    /**
	 * @brief Get share setting helper object.
	 * @return If the function succeeds, the return value is the share setting helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKShareSettingHelper \endlink.
	 */
	virtual IZoomVideoSDKShareSettingHelper* getShareSettingHelper() = 0;

    /**
	 * @brief Get live transcription helper object.
	 * @return If the function succeeds, the return value is the live transcription helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKLiveTranscriptionHelper \endlink.
	 */
	virtual IZoomVideoSDKLiveTranscriptionHelper* getLiveTranscriptionHelper() = 0;

    /**
	 * @brief Get incoming live stream helper object.
	 * @return If the function succeeds, the return value is the incoming live stream helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKIncomingLiveStreamHelper \endlink.
	 */
	 ...
	 * @return If the function succeeds, the return value is the subsession helper object. Otherwise returns nullptr. For more details, see \link IZoomVideoSDKSubSessionHelper \endlink.
     */
