...
These sample apps are based on version.txt
A collection of C++ Application demonstrating different Zoom Video SDK features
...
Each project is in its VSDK_xxxxxxxx folder
